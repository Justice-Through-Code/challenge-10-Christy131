...
from playlist_helpers import add_song, display_playlist
...
jams_2 = {'artist': 'Tayxlor Acorn', 'title': 'Unwell'}
add_song(my_playlist, jams_2)
...
jams = {'artist': 'J. Cole', 'title': 'Love Yourz'}
add_song(my_playlist, jams)
jams_2 = {'artist': 'Taylor Acorn', 'title': 'Unwell'}
add_song(my_playlist, jams_2)
